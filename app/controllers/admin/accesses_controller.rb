...
class Admin::AccessesController < Admin::MasterController
...
=begin
  ...
  #
  #   admin:
  #     Access: create, read, update, destroy, custom_action
  #
  #   editor:
  #     Access: create, read, update, custom_action_for_an_item
  #
